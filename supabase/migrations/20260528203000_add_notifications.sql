-- =========================================================================
-- Majal Mental Health — Real-Time Notification System Migration
-- =========================================================================
...
-- Enable Realtime for the table in Supabase
-- Note: Realtime is configured via the supabase publication, but enabling replication identity allows full payload updates
...
-- 1. Trigger: New booking created (Notify therapist)
...
-- 2. Trigger: Booking status updated (Notify patient)
...
BEGIN
  IF OLD.status IS DISTINCT FROM NEW.status THEN
    ...
    IF therapist_name IS NULL THEN
      therapist_name := 'Votre thérapeute';
    END IF;
...
-- 3. Trigger: New message inserted (Notify receiver)
