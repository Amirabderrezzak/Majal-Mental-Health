...
import { sendTherapistApproved, sendTherapistRejected } from "./_lib/email.js";
...
export const notifyTherapistHandler = async (req: any, res: any) => {
  if (req.method !== "POST") {
...
export default async function handler(req: any, res: any) {
  const action = (req.query.action as string) || "notify-therapist";

  switch (action) {
    case "notify-therapist":
      return notifyTherapistHandler(req, res);
    default:
